...
def _review_prompt(
    ...
    return (
        ...
        "task. Historical feedback is context only, not proof that a current requirement remains unsatisfied. This "
        "review sandbox is intentionally read-only: do not rerun pytest, build, formatter, cache-generating, or other commands that require writing repository or temporary "
